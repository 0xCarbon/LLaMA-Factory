...
from .tool_utils import DefaultToolUtils, GLM4ToolUtils, MistralNemoToolUtils
...
class ToolFormatter(Formatter):
    def __post_init__(self):
        ...
        elif self.tool_format == "mistral_nemo":
            self._tool_formatter = MistralNemoToolUtils.tool_formatter
            self._tool_extractor = MistralNemoToolUtils.tool_extractor
        else:
            raise NotImplementedError("Tool format {} was not found.".format(self.tool_format))
